...
np.savetxt('k_AP_ref_Totsaf_hfix_v1.txt', k_AP_ref, fmt='%.10f')
np.savetxt('k_AP_up_Totsaf_hfix_v1.txt', k_AP_up, fmt='%.10f')
...
print('mu_AP ref', mu_AP_ref)
print('mu_AP h up', mu_AP_up)

err_z = Fz(0.99, k_list_1, 0.5, er_FH=H(0.99)**(1+eps_H))
np.savetxt('z_error_Totsaf_hfix_v1.txt', err_z, fmt='%.10f')
...
np.savetxt('P_obs_ref_Totsaf_hfix_v1.txt', P_obs_ref, fmt='%.10f')

P_obs_up = P_obs(k_list_1, 0.5, 0.99, 10**P_m(np.log10(k_list_1)),
                  10**P_m_NW(np.log10(k_list_1)), 1.4541449979*sig_8_fid,
...
P_obs_down = P_obs(k_list_1, 0.5, 0.99, 10**P_m(np.log10(k_list_1)),
                    10**P_m_NW(np.log10(k_list_1)), 1.4541449979*sig_8_fid,
                    8.7797912597e-01*sig_8_fid, H(0.99)**(1-eps_H), H_ref(0.99),
                    D_A(0.99)**(1-eps_Da), D_A_ref(0.99), sig_p_fid[0],
                    sig_v_fid[0])
np.savetxt('P_obs_down_Totsaf_hfix_v1.txt', P_obs_down, fmt='%.10f')
...
out_J = open("output/Jacobian_default", "w")
i, j = 0, 0
