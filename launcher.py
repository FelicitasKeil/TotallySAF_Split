...
if(Codes_choices["XSAF_ch"] == '0'):
	...
	os.system("g++ -c main.cpp XSAF_C.cpp -fopenmp -mfma -O3 -ffast-math -fno-signed-zeros -fno-trapping-math -funroll-loops -frename-registers")
	os.system("g++ XSAF_C.o main.cpp -o main.exe -fopenmp -mfma -O3 -ffast-math -fno-signed-zeros -fno-trapping-math -funroll-loops -frename-registers")
	os.system("./main.exe")
	os.chdir("../")
else:
